...
class SysMessageController extends Controller
{
	 ...
	 */
	// For illustrative purposes only, i.e., if using simple access rule; since we're using RBAC in AdminModule::beforeControllerAction(), this could actually be removed entirely
	public function accessRules()
	{
		return array(
			array('allow',  // allow only to admin role
