...
class m130502_170728_create_issue_user_and_assignment_tables extends CDbMigration
{
	public function up()
	{
        ...
        // Create assignment table for many-to-many relationship
        ...
        // tbl_issue.project_id references tbl_project.id
        $this->addForeignKey('fk_issue_project', 'tbl_issue', 'project_id',
                'tbl_project', 'id', 'CASCADE', 'RESTRICT');
        
        // tbl_issue.owner_id references tbl_user.id
        $this->addForeignKey('fk_issue_owner', 'tbl_issue', 'owner_id', 'tbl_user',
                'id', 'CASCADE', 'RESTRICT');
        
        // tbl_issue.requester_id references tbl_user.id
        $this->addForeignKey('fk_issue_requester', 'tbl_issue', 'requester_id',
                'tbl_user', 'id', 'CASCADE', 'RESTRICT');
        
        // tbl_project_user_assignment.project_id references tbl.project.id
        $this->addForeignKey('fk_project_user', 'tbl_project_user_assignment',
                'project_id', 'tbl_project', 'id', 'CASCADE', 'RESTRICT');
        
        // tbl_project_user_assignment.user_id references tbl_user.id
