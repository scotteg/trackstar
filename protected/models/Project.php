...
class Project extends TrackStarActiveRecord
{
    ...
    {
        // Using Yii query builder instead of Active Record
        $command = Yii::app()->db->createCommand();
        $command->insert('tbl_project_user_assignment', array('role'=>$role, 'user_id'=>$userId, 'project_id'=>$this->id));
    }
    ...
    {
        // Execute SQL directly, instead of using query builder or Active Record
