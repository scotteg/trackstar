...
{
    public $password_repeat; // The compare rule will automatically look for a matching attribute with the _repeat suffix
    ...
    /*
     * Check if passed in password is correct
    ...
    protected function afterValidate()
    {
        ...
        if (!$this->hasErrors()) {
            $this->password = crypt($this->password, $this->password); // Use password as the salt, too!
        }
    }
}